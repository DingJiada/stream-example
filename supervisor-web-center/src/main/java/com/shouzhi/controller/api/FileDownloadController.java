...
public class FileDownloadController extends BaseController {
     ...
     *          sch_device：学校设备导入模板.xls、sch_course_category：学校课程类别导入模板.xls、sch_grade_class：学校班级数据导入模板.xls、
     *          sys_department: 学校组织数据导入模板.xls、
    ...
    public void excelTemplate(@RequestParam("fName") String fName, HttpServletRequest req, HttpServletResponse resp){
        ...
        switch (fName){
            ...
            case "sch_course_category":
                ...
                break;
            case "sch_grade_class":
                FileDownloadUtil.projectFile("学校班级数据导入模板.xls", FilePathConst.REL_EXCEL_IMP_PATH+"sch_grade_class.xls", req, resp);
                break;
            case "sys_department":
                FileDownloadUtil.projectFile("学校组织数据导入模板.xls", FilePathConst.REL_EXCEL_IMP_PATH+"sys_department.xls", req, resp);
                break;
            default:
